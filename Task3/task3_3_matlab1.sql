...
-- sql command 30
SELECT A.PointName, WFCode, WeekStartDate
    , WeeklyWaterlevel, WeeklyWaterlevel-AvgMin Deviation
    , FiftytwoWeek_MAV, FiftytwoWeek_MAV-AvgMin Deviation_MAVG
FROM RA_UFAS_WeeklyWL A
